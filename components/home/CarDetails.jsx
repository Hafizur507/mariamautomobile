        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-8 space-y-8">
            <div className="max-w-3xl">
              ...
              <h1 className="text-5xl font-black uppercase tracking-tighter mb-4">{car.name}</h1>
              ...
              {!showAllImages ? (
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 animate-in fade-in duration-500">
                  {allImages.map((img, i) => (
                    ...
                    >
                      <Image fill src={img} alt="gallery" className="w-full h-full object-cover" />
                    </div>
                  ))}
                  <button
            ...
            <div className="lg:col-span-4">
              <div className="bg-[#111] p-8 rounded-[3rem] border border-white/5 shadow-2xl sticky top-10 space-y-8">
                {/* প্রাইস ও স্পেক্স সেকশন... */}

                {/* 🆕 ব্রোশার ডাউনলোড বাটন */}
                <BrochureDownloadButton car={car} />
          ...
          <div className="lg:col-span-4">
            <div className="bg-[#111] p-8 rounded-[3rem] border border-white/5 shadow-2xl sticky top-10 space-y-8">
              ...
              {/* কুইক স্পেকস */}
              <div className="space-y-4">
                <SpecRow icon={<FaCalendarDays />} label="Model Year" value={car.modelYear} />
                <SpecRow icon={<FaPalette />} label="Color" value={car.color} />
                <SpecRow icon={<FaAward />} label="AU Grade" value={car.auGrade} />
                <SpecRow icon={<FaRoad />} label="Mileage" value={car.mileage} />
              </div>
...
const SpecRow = ({ icon, label, value }) => (
  <div className="flex justify-between items-center group">
    <div className="flex items-center gap-3 text-gray-500">
      <span className="text-red-600 group-hover:scale-110 transition-transform">{icon}</span>
...
//   FaWhatsapp,
// } from 'react-icons/fa6';
// import EMICalculator from './EMICalculator'; // 👈 ইমপোর্ট করুন
...
//             {/* 🆕 আলাদা ইএমআই ক্যালকুলেটর কম্পোনেন্ট কল করা হলো */}
//             <EMICalculator carPrice={car.price} carName={car.name} chassisNo={car.chassisNo} />
//           </div>
...
//                 <SpecRow icon={<FaCalendarDays />} label="Model Year" value={car.modelYear} />
//                 <SpecRow icon={<FaPalette />} label="Color" value={car.color} />
//                 <SpecRow icon={<FaAward />} label="AU Grade" value={car.auGrade || car.au_grade} />
//                 <SpecRow icon={<FaRoad />} label="Mileage" value={car.mileage} />
//               </div>
...
//               <a
//                 href={`https://wa.me/88017XXXXXXXX?text=${encodeURIComponent(`Hi, I want to know more about ${car.name} (Chassis: ${car.chassisNo})`)}`}
//                 target="_blank"
